...
public class CacheConfig {
    ...
    public RedisCacheManager cacheManager(
        ...
        redisCacheConfigMap.put(
                ...
                defaultConfig.entryTtl(Duration.ofHours(4))  // entryTtl()을 호출하여 캐시 항목의 만료 시간(TTL)을 설정, 캐시 수명 4시간
        );
        ...
        redisCacheConfigMap.put(
                ...
                defaultConfig.entryTtl(Duration.ofHours(4))
                        .serializeValuesWith(  // serializeValuesWith()를 호출하여 값을 직렬화하는 방식 설정
                                RedisSerializationContext
                                        .SerializationPair
